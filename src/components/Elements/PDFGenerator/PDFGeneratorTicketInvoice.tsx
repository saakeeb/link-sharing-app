  ...
  return (
    <View style={styles.tableContainer}>
      <View style={styles.container}>
        <Text style={styles.tableHeadingLarge}>Item name</Text>
        <Text style={styles.tableHeadingSmall}>Unit</Text>
        <Text style={styles.tableHeadingSmall}>Quantity</Text>
        <Text style={styles.tableHeadingSmall}>Rate</Text>
...
const InvoiceTableRow = ({ items }: any) => {
  ...
  const rows = items?.map((item: any) => (
    <View style={styles.row} key={item.id}>
      <Text style={styles.tableDataLarge}>{item.item_name}</Text>
      <Text style={styles.tableDataSmall}>{item.unit}</Text>
      <Text style={styles.tableDataSmall}>{item.quantity}</Text>
      <Text style={styles.tableDataSmall}>{item.rate}</Text>
      <Text style={styles.tableDataSmall}>{item.amount}</Text>
    </View>
  ));
...
export const PDFGeneratorTicketInvoice = ({ tableData }: any) => {
      ...
      <Document>
        <Page size="A4" style={styles.page}>
          <View>
            ...
            <InvoiceItemsTable invoice={tableData.items} />
