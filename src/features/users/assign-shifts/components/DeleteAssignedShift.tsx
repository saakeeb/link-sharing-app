...
import { useDeleteAssignedShift } from '../api/deleteAssignedShifts';
import { AssignedShiftProps } from '../types';

const DeleteAssignedShift: React.FC<AssignedShiftProps> = ({ data }) => {
  const deleteMutation = useDeleteAssignedShift();
  ...
  return (
    <ConfirmationDialog
      ...
      body={
        <>
          <p>
            Are you sure you want to delete this assigned shift to:{' '}
...
export default DeleteAssignedShift;
